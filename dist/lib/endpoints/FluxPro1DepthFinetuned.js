...
class FluxPro1DepthFinetuned extends bflApiBaseConnector_1.default {
    ...
    generateImage(prompt_1, finetuneId_1, options_1) {
        return __awaiter(this, arguments, void 0, function* (prompt, finetuneId, options, onDownloadProgress = ((progressEvent) => { }), onUploadProgress = ((progressEvent) => { })) {
            ...
            return yield this.post("flux-pro-1.0-depth", data, onDownloadProgress, onUploadProgress);
        });
    }
}
exports.default = FluxPro1DepthFinetuned;
