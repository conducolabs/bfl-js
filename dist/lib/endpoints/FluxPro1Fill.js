...
class FluxPro1Fill extends bflApiBaseConnector_1.default {
    ...
    generateImage(prompt_1, options_1) {
        return __awaiter(this, arguments, void 0, function* (prompt, options, onDownloadProgress = ((progressEvent) => { }), onUploadProgress = ((progressEvent) => { })) {
            ...
            return yield this.post("flux-pro-1.0-fill", data, onDownloadProgress, onUploadProgress);
        });
    }
}
exports.default = FluxPro1Fill;
